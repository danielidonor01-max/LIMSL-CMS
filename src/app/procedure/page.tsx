...
export default function ProcedurePage() {
  ...
  return (
    <div className="p-6 max-w-4xl w-full mx-auto space-y-8">
      ...
      {/* Revision history */}
      {showHistory && (
        <div className="no-print bg-surface border border-line rounded-xl shadow-card p-4">
      ...
      {/* Propose editor */}
      {editing && (
        <div className="no-print bg-surface border border-line rounded-xl shadow-card p-5 space-y-3">
      ...
      <div className="bg-surface border border-line rounded-xl shadow-card p-8 print:border-0 print:p-0" id="procedure-doc">
