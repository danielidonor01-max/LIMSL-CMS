...
const STATUS_BADGE: Record<string, string> = {
  ...
  DUE_SOON: "bg-warn-500/10 text-warn-600 border-warn-500/20",
  OVERDUE: "bg-danger-500/10 text-danger-600 border-danger-500/20",
  OUT_OF_SERVICE: "bg-ink-500/10 text-ink-500 border-ink-500/20",
};
    ...
    <div className="min-h-screen bg-canvas text-ink-900 flex flex-col font-sans">
      <main className="flex-1 p-6 lg:p-8 max-w-6xl w-full mx-auto space-y-8">
        ...
        {loading ? (
          ...
          <>
            {summary.OVERDUE > 0 && (
              <div className="flex items-center gap-2 px-4 py-3 rounded-xl border border-danger-200 bg-danger-50 text-danger-700 text-xs">
      ...
      >
        {eventsLoading ? (
          <div className="py-10 flex justify-center items-center text-ink-500">
