        ...
        {actions.map((a) => {
          ...
          return (
            <Link
              key={a.title}
              href={a.href}
              className="flex items-center gap-4 bg-surface border border-line rounded-xl shadow-card p-4 min-h-[76px] hover:border-brand-300 hover:shadow-card active:scale-[0.99] transition-all group"
            >
