...
const INDEXES: [string, string][] = [
  ...
  ["equipment.removal", "ALTER TABLE equipment ADD COLUMN IF NOT EXISTS removed_at text, ADD COLUMN IF NOT EXISTS removed_reason text, ADD COLUMN IF NOT EXISTS removed_note text, ADD COLUMN IF NOT EXISTS removed_by_id text, ADD COLUMN IF NOT EXISTS removed_by_name text"],
  [
