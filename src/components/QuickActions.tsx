    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          role="menu"
          aria-label="Create"
          className="absolute right-0 mt-2 w-60 bg-surface border border-line rounded-xl shadow-card shadow-raised overflow-hidden z-50"
        >
          <div className="px-3 py-2 text-xs font-semibold text-ink-500 border-b border-ink-100">
            Create
          </div>
          {actions.map((a) => {
            const Icon = a.icon;
