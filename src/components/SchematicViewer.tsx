...
export default function SchematicViewer({
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-b border-ink-200 shrink-0">
            ...
            <p className="text-xs text-ink-500">
              {schematicReference ? (
                <span className="inline-flex items-center gap-1">
                  ...
                  {focusRect ? (
                    <span className="text-brand-600">· exact location</span>
                  ) : zoneRect ? (
                    <span className="text-ink-400">· approximate zone</span>
                  ) : null}
                </span>
              ) : reviewing ? (
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {pages && pages.length > 1 && !zoomTile && (
              <div className="flex items-center gap-1 text-xs text-ink-600">
                <button
                  ...
                  disabled={pageIdx === 0}
                  className="p-1.5 rounded-lg hover:bg-ink-100 disabled:opacity-30"
                >
            ...
            <button onClick={onClose} className="p-1.5 rounded-lg text-ink-400 hover:text-ink-900 hover:bg-ink-100">
              <X className="w-4 h-4" />
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-hidden flex">
          <div className="flex-1 overflow-auto p-4 bg-ink-50">
            {loading ? (
              ...
              <div className="h-64 flex flex-col items-center justify-center gap-3 text-center">
                <Grid2x2 className="w-8 h-8 text-ink-300" />
                  ...
                  <div className="flex flex-wrap items-end gap-2 p-3 rounded-lg border border-brand-200 bg-brand-50">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-44 bg-white border border-ink-200 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none focus:border-brand-500/40"
                      />
                    </div>
                    <div className="space-y-1">
              ...
              <div className="space-y-2">
                <div className="relative inline-block rounded-lg border border-ink-200 bg-white overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
 ...
 c.include ? "border-info-500 bg-info-400/25" : "border-ink-300 bg-ink-200/20"
          ...
          {/* Review panel */}
          {reviewing && (
            <div className="w-80 shrink-0 border-l border-ink-200 flex flex-col bg-white">
